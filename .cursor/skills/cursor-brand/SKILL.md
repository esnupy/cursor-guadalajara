...
Prefer using the react component variations for the logo in code, using tailwind utility classes to change the main
color on specific cases. Otherwise it defaults to the `text-foreground` variant based on the selected theme.
